...
class Fail extends Component {
  ...
  componentDidMount(){
    ...
    if(status === 'validation_failed'){
        this.setState({payment_message: 'Payment Validation Failed!'});
    } else if(status === 'invalid_transaction'){
        this.setState({payment_message: 'Payment Invalid Transaction!'});
    } else if(status === 'transaction_failed'){
        this.setState({payment_message: 'Payment Transaction Failed!'});
            ...
            <div className="offcanvas offcanvas-start show" tabIndex={-1} id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
              ...
              <div className="offcanvas-body">
                ...
                <div className="left-offcanvas">
                    <p style={{"text-align":"center"}}><i className="fa fa-exclamation-triangle" aria-hidden="true" style={{"color":"#ff0000", "fontSize":"80px"}}></i></p>
                    <h4 className="mt-3" style={{"color":"#ff0000", "text-align":"center"}}>Payment Failed!</h4>
