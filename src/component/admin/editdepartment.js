...
const updateDepartment = (id, data, edit_department_desc_one, edit_department_desc_two, edit_department_desc_three, edit_department_desc_four, edit_department_desc_five,edit_department_image) => {
    ...
    formdata.append('edit_department_image', edit_department_image);
...
class EditDepartment extends Component {
    ...
    handleSubmit = event => {
        ...
        if (this.validateForm()===true) {
            ...
            updateDepartment(id, data, this.state.edit_department_desc_one, this.state.edit_department_desc_two, this.state.edit_department_desc_three, this.state.edit_department_desc_four, this.state.edit_department_desc_five,this.state.edit_department_image)
            .then(res => {
        ...
        .then(res => {
            if(res.status===true){
                ...
                this.setState({
                    ...
                    edit_department_id: records.dept_id,
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-sm-6">
                                                        <div className="form-group">
                                                            ...
                                                            <input type="text" className="form-control" name="edit_department_id" id="edit_department_id" value={this.state.edit_department_id} onChange={this.handleChange} required placeholder="Department Id" readOnly/>
                                                ...
                                                <div className="row">
                                                    <div className="col-sm-6">
                                                        <div className="form-group">
                                                            ...
                                                            <input type="file" className="form-control" name="edit_department_image" id="edit_department_image" onChange={ (event) => this.onFileChange(event.target.files) } accept="jpg,png"/>
