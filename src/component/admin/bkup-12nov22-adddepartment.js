...
const saveDepartment = (data, department_desc_one, department_desc_two, department_desc_three, department_desc_four, department_desc_five) => {
...
class AddDepartment extends Component {
    ...
    /*onChangeDescOne = (evt) =>{
        ...
        this.setState({
            department_desc_one: newContent,
        })
    }
    onChangeDescTwo = (evt) =>{
        //console.log("onChange fired with event info: ", evt);
        var newContent = evt.editor.getData();
        this.setState({
            department_desc_two: newContent,
        })
    }
    onChangeDescThree = (evt) =>{
        ...
        var newContent = evt.editor.getData();
        this.setState({
            department_desc_three: newContent,
        })
    }
    onChangeDescFour = (evt) =>{
        ...
        var newContent = evt.editor.getData();
        this.setState({
            department_desc_four: newContent,
        })
    }
    onChangeDescFive = (evt) =>{
        ...
        var newContent = evt.editor.getData();
        this.setState({
            department_desc_five: newContent,
        })
    }*/
    handleSubmit = event => {
        ...
        if (this.validateForm()) {
            ...
            const data = {
                department_name: this.state.fields.department_name,
            ...
            saveDepartment(data, this.state.department_desc_one, this.state.department_desc_two, this.state.department_desc_three, this.state.department_desc_four, this.state.department_desc_five)
            .then(res => {
                                                ...
                                                <div className="row">
                                                    <div className="col-sm-12">
                                                        <div className="form-group">
                                                            ...
                                                            <input type="text" className="form-control" name="department_name" id="department_name" value={this.state.fields.department_name} onChange={this.handleChange} required placeholder="Department Name"/>
