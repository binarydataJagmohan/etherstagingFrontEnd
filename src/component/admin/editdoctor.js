...
const updateDoctor = (id, data, edit_doctor_desc, edit_doctor_edu, edit_doctor_exp, imageData) => {
    let formdata = new FormData();
    formdata.append('edit_doctor_desc', edit_doctor_desc);
    formdata.append('edit_doctor_edu', edit_doctor_edu);
    formdata.append('edit_doctor_exp', edit_doctor_exp);
    formdata.append('edit_doctor_profile', imageData);
    return new Promise((resolve, reject) => {
        const req = scAxiosAdmin.post('/doctors/updatedoctor/'+id, formdata, {
          headers: {
    ...
    handleSubmit = event => {
        ...
        if (this.validateForm()===true) {
            ...
            const data = {
                ...
                //edit_doctor_edu: this.state.edit_doctor_edu,
                //edit_doctor_exp: this.state.edit_doctor_exp,
            }
            updateDoctor(id, data, this.state.edit_doctor_desc, this.state.edit_doctor_edu, this.state.edit_doctor_exp, this.state.edit_doctor_profile)
            .then(res => {
        ...
        .then(res => {
            if(res.status===true){
                ...
                this.setState({
                    ...
                    edit_doctor_exp: records.doctor_exp,
                    edit_doctor_edu: records.doctor_edu,
                });
            } else {
                this.setState({ 
                    doctor_id: '', 
                                                    ...
                                                    <div className="col-sm-12">
                                                        <div className="form-group">
                                                            ...
                                                            <MultipleReactQuillEditor
                                                                id="desceditor"
                                                                name="desceditor"
                                                                value={this.state.edit_doctor_desc}
                                                    ...
                                                    <div className="col-sm-12">
                                                        <div className="form-group">
                                                            ...
                                                            <MultipleReactQuillEditor
                                                                id="edueditor"
                                                                name="edueditor"
                                                                value={this.state.edit_doctor_edu}
                                                    ...
                                                    <div className="col-sm-12">
                                                        <div className="form-group">
                                                            ...
                                                            <MultipleReactQuillEditor
                                                                id="expeditor"
                                                                name="expeditor"
                                                                value={this.state.edit_doctor_exp}
